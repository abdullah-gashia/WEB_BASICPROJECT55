...
export default function Header({ 
    ...
    return (
        <header className="bg-[#fff] shadow-md px-4 py-3 relative z-50">
                ...
                {user && (
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 text-vlack hover:text-white transition-colors p-2 rounded-md"
                        >
                            <div className="w-8 h-8 rounded-full bg-[#ff2121] flex items-center justify-center">
